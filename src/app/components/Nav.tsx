    ...
    <nav>
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex space-x-2">
          <Link
            href="https://vercel.com/new/clone?repository-url=https://github.com/mrepol742/shortlink-app"
            target="_blank"
            className="flex flex-row btn bg-black text-white py-1 px-3 rounded-lg items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 1155 1000"
              className="fill-white w-4 h-4 me-2"
            >
              {/* Vercel Logo */}
              <path d="M577.3 0L1154.7 1000H0L577.3 0Z" />
            </svg>
            Deploy
          </Link>
          <Link
            href="https://github.com/mrepol742/shortlink-app/fork"
            className="flex flex-row btn bg-black text-white py-1 px-3 rounded-lg items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
